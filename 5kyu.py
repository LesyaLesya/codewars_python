...
class PaginationHelper:
    ...
    def __init__(self, collection, items_per_page):
        ...
        self.splited = [self.collection[i:i + self.items_per_page] for i in range(0, len(self.collection), self.items_per_page)]
    ...
    def page_item_count(self, page_index):
        ...
        try:
            return len(self.splited[page_index])
        except IndexError:
            return -1
...
print(empty.page_count())
print(empty.item_count())
print(empty.page_item_count(0))
print(empty.page_item_count(1))
print(empty.page_item_count(-1))
print(empty.page_index(0))
print(empty.page_index(1))
print(empty.page_index(-1))
